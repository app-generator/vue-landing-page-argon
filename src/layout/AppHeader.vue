    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="https://github.com/app-generator/vue-landing-page-argon"
                ...
                <li class="nav-item d-none d-lg-block ml-lg-4">
                    <a href="https://github.com/app-generator/vue-landing-page-argon" target="_blank" rel="noopener"
